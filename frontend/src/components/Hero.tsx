    ...
    >
      ...
      <div className="col-span-12 lg:col-span-7 p-6 md:p-12 lg:p-16 flex flex-col justify-between border-r border-white/10 pt-24 md:pt-32 lg:pt-40 pb-12">
        <div>
          ...
          >
            BUILD<br/>DEPLOY<br/>SECURE<span className="text-accent">.</span>
          </h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end gap-12 mt-16 md:mt-20">
          <div className="max-w-xs">
            <p className="text-sm text-paper/40 leading-relaxed font-sans mb-2">
              Full-stack MERN developer and Cloud DevOps engineer dedicated to building resilient, scalable, and secure digital infrastructures.
            </p>
          </div>
          <div className="flex flex-col gap-4">
            <span className="text-[9px] uppercase tracking-widest text-paper/30 font-bold">Domain Expertise</span>
            <div className="flex flex-wrap gap-2">
              <span className="px-4 py-1.5 border border-white/10 text-[9px] uppercase tracking-widest font-bold">MERN Stack</span>
              <span className="px-4 py-1.5 border border-white/10 text-[9px] uppercase tracking-widest font-bold">DevSecOps</span>
              <span className="px-4 py-1.5 border border-white/10 text-[9px] uppercase tracking-widest font-bold">Cloud Arch</span>
            </div>
          </div>
        </div>
      </div>
